    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if ("/login".equals(path)) {
            ...
            try {
                ...
                String token = JwtUtil.generateToken(UUID.fromString(user.getId()), user.getLogin(), user.getRole(), user.getLastname(), user.getFirstname(), user.getMiddlename(), user.getTenantId());
